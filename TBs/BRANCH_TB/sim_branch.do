...
add wave -radix binary /branch_tb/dut/jump_c
add wave -radix binary /branch_tb/dut/branch_c
add wave -radix binary /branch_tb/dut/pcsource_c


add wave -divider "Entradas de dados"
add wave -radix decimal /branch_tb/dut/rs1_i
add wave -radix decimal /branch_tb/dut/pc_i
add wave -radix decimal /branch_tb/dut/aluout_i
add wave -radix decimal /branch_tb/dut/imm_i


add wave -divider "Saídas de dados"
add wave -radix decimal /branch_tb/dut/pc_next_o
